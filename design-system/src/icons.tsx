...
export function StarIcon(props: SVGProps<SVGSVGElement>) {
  // The prototype's exact star (viewBox 640×640). No fill on the path so it
  // inherits the svg's fill from context (.stars → gold, .day .pips → gold).
  return (
    <svg viewBox="0 0 640 640" aria-hidden focusable={false} {...props}>
